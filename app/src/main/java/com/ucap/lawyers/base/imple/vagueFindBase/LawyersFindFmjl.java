...
public class LawyersFindFmjl extends PagerBase {

    @Bind(R.id.lv_content)
    ListView lvContent;
    @Bind(R.id.ll_loading)
    LinearLayout lLoading;
    ArrayList<LawyersFindData.FmjlrowsBean> mListDate;

    public ContentAdapter adapter;

    public LawyersFindFmjl(Activity mActivity, ArrayList<LawyersFindData.FmjlrowsBean> listFmjl) {
        super(mActivity);
        this.mListDate = listFmjl;
        setDate();
    }
    ...
    public void setDate() {
        ...
        adapter.onSetItemClick(new OnsetItemClick() {
            ...
            public void onLvItemClick(int position) {
                LawyersFindData.FmjlrowsBean rowsBean = mListDate.get(position);
                JumpDetailedTools.jumpLawyerFmjlDetailed(mActivity, rowsBean);//跳转到详细
            }
    ...
    class ContentAdapter extends BaseAdapter {
        ...
        @Override
        public LawyersFindData.FmjlrowsBean getItem(int position) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            LawyersFindData.FmjlrowsBean item = getItem(position);
