...
public class LawyersFindGyfw extends PagerBase {
    @Bind(R.id.lv_content)
    ListView lvContent;
    @Bind(R.id.ll_loading)
    LinearLayout lLoading;
    ArrayList<LawyersFindData.GyfwrowsBean> mListDate;
    public ContentAdapter adapter;

    public LawyersFindGyfw(Activity mActivity, ArrayList<LawyersFindData.GyfwrowsBean> mListData) {
        super(mActivity);
    ...
    public void setDate() {
        ...
        adapter.onSetItemClick(new OnsetItemClick() {
            ...
            public void onLvItemClick(int position) {
                LawyersFindData.GyfwrowsBean rowsBean = mListDate.get(position);
                JumpDetailedTools.jumpLawyerGyfwDetailed(mActivity, rowsBean);
            }
    ...
    class ContentAdapter extends BaseAdapter {
        ...
        @Override
        public LawyersFindData.GyfwrowsBean getItem(int position) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            LawyersFindData.GyfwrowsBean item = getItem(position);
